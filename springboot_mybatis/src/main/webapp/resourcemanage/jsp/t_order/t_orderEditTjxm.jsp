...
function loadTaocan(){
    ...
    var url = '<%=basePath%>loadTaocanTjxmByOrderid.action?orderid='+orderid+'&time='+Math.random();
    //alert(url);
    //要提交到服务器的数据
    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·业务管理&gt;&gt; 订单管理&gt;&gt; 调整体检项目</span></td>
      </tr>
      <tr>
                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >调整体检项目</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">                                             
						   ...
						   <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
	                        ...
	                        <tr>
		                        <td valign="top" bgcolor="cbcbcb"  colspan="8" align="center">		                                                         
	                               <table id="table0" width="98%" border="0" cellspacing="0" cellpadding="0">
			                          <tr>
...
<input type="button"   class="btn"  value="    返回    " name="B1" onClick="javascript:window.location.href='<%=basePath%>T_orderActionList.action'">&nbsp;&nbsp;
