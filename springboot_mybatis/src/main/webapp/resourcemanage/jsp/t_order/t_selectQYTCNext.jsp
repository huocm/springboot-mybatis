...
function checkValue(){
    if(checkfunctionIDS()){  
		var url = '<%= basePath %>saveBjdTaocanOne.action?orderid=${t_order_sub.orderid }&ordersubid=${t_order_sub.ordersubid }';
                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >套餐信息</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
                            <tr>
							  <td width="20%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">套餐名称:</td>
                              <td width="30%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;${t_order_sub.memo } </td>
                              <td width="20%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">&nbsp;体检机构:</td>                                                           
                              <td width="30%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp; ${t_order_sub.companypname } </td>
                            </tr>														
							
							<tr>
                        <td colspan="6" valign="top" bgcolor="cbcbcb">
                          ...
                          <s:iterator value="t_order_products_subList" status="stuts">
							<tr id="aid<s:property value='id' />" onClick="changeTrColor(id)" style="cursor:hand" bgcolor="#FFFFFF" align="center">
					          ...
					          <td height="25" align="center" valign="middle">&nbsp;
					          	 <a href='<%=basePath %>T_order_products_subActionRemove.action?id=${id }&orderid=${t_order_sub.orderid }&ordersubid=${t_order_sub.ordersubid }'><img src='<%= basePath %>images/delete.png' border="0" alt="删除" title="删除"  height="15" >删除</a>&nbsp;        					   					          		
					          </td>
					        </tr>					      
					      </s:iterator>
					    </table></td>
                      ...
                      <tr>
                        ...
                        <tr>
		                      <td height="36" colspan="13" align="center" valign="middle" bgcolor="#FFFFFF">
			                     ...
			                     <input type="button" name="gb" value="    返回   " class="btn" onClick="javascript:window.parent.location.href='<%=basePath %>T_orderActionSaveOrderDEB.action?orderid=${t_order_sub.orderid }'" >&nbsp;
