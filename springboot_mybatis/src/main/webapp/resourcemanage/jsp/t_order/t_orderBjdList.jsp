                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >报价单信息查询</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
				            <s:form action="T_orderBjdActionList" theme="simple"  target="" >                   				
							<tr>
                  ...
                  <td height="229" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="21" background="<s:url value='/images/1_27.gif'/>"><img src="<s:url value='/images/1_26.gif'/>" width="21" height="24"></td>
                              <td background="<s:url value='/images/1_27.gif'/>" class="daohang">&nbsp;报价单信息列表页&nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td valign="top" bgcolor="cbcbcb">
                          <table id="table0" width="100%" border="0" cellspacing="1" cellpadding="0" class="sortable">
                            <tr>
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">报价单编号</strong></th>          
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">发起人</strong></th>          
					            ...
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">报价单状态</strong></th>          					            
					            ...
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">联系电话</strong></th>  					            					                  
					             -->
                          ...
                          <s:iterator value="paginationSupport.items" status="stuts">
							<tr id="aid<s:property value='id' />" onClick="changeTrColor(id)" style="cursor:hand" bgcolor="#FFFFFF" align="center">
					         ...
					         <s:if test="'${creater}' == '${sessionScope.userName}'">
					            <!-- 状态为‘报价单录入’且‘creater创建人==当前登录用户’ 显示提交按钮 -->
					            
					          	<s:if test="'${checkstatus}' == '报价单录入'">						          	    				          	
						          		<a href='<s:url action="T_orderActionSaveOrderDEB.action"><s:param name="orderid" value="id" /><s:param name="returnUrl" value="view" /></s:url>'><img src='<%= basePath %>images/modify.png' border="0" alt="编辑" title="编辑"  height="15" >编辑报价单</a>&nbsp;                          
						          		<!-- 
					          	...
					          	<a href='<s:url action="T_orderActionBJDView.action"><s:param name="orderid" value="id" /><s:param name="returnUrl" value="view" /></s:url>'><img src='<%= basePath %>images/view.png' border="0" alt="查看" title="查看"  height="15" >查看报价单详情</a>
					          </td>
					        </tr>					      
					      </s:iterator>
					    </table></td>
                      ...
                      <tr>
                        <td height="22" align="center" colspan="100" bgcolor="#FFFFFF">
							 ...
							 <a href='<s:url value="/T_orderBjdActionList.action">
