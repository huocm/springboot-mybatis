    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·业务管理&gt;&gt; 订单费用管理</span></td>
      </tr>
      <tr>
                      ...
                      <tr>
                        <td bgcolor="cbcbcb">
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
				            <s:form action="T_orderActionDdfyList" theme="simple"  target="" >                   				
							<tr>
                  ...
                  <td height="229" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="21" background="<s:url value='/images/1_27.gif'/>"><img src="<s:url value='/images/1_26.gif'/>" width="21" height="24"></td>
                              <td background="<s:url value='/images/1_27.gif'/>" class="daohang">&nbsp;费用申请信息列表页&nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td valign="top" bgcolor="cbcbcb">
                          <table id="table0" width="100%" border="0" cellspacing="1" cellpadding="0" class="sortable">
                            <tr>
					            ...
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">订单打折后总金额(元)</strong></th>                 				                 
					            ...
					            <th width="" height="22" align="center" bgcolor="#F2F2F2"><strong class="liebiaotitle">已申请费用总金额(元)</strong></th>					                    
                          ...
                          <s:iterator value="paginationSupport.items" status="stuts">
							<tr id="aid<s:property value='id' />" onClick="changeTrColor(id)" style="cursor:hand" bgcolor="#FFFFFF" align="center">
					          ...
					          <td height="25" align="center" valign="middle">&nbsp;
					            		...
					            		<fmt:formatNumber value="${unreceiveamount}" pattern="0.00"/>   					                   
					          </td>
					          <td height="25" align="center" valign="middle">&nbsp;
					          ...
					          <td height="25" align="center" valign="middle">&nbsp;					       
					          	<a href='<s:url action="T_orderActionDdfyAdd.action"><s:param name="id" value="id" /><s:param name="returnUrl" value="view" /></s:url>'><img src='<%= basePath %>images/tonguo.png' border="0" alt="对该订单申请费用" title="申请费用"  height="15" >申请费用</a>
					          </td>
					        </tr>					      
					      </s:iterator>
					    </table></td>
                      ...
                      <tr>
                        <td height="22" align="center" colspan="100" bgcolor="#FFFFFF">
							 ...
							 <a href='<s:url value="/T_orderActionDdfyList.action">
