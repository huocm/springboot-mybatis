...
function loadTcmc(){
	...
	var customerid=${t_member.customerid};
	//alert(customerid);
	var url = '<%=basePath%>T_tcmcFindAll.action?customerid='+customerid+'&time='+Math.random();
	//alert(url);
	//要提交到服务器的数据
...
//提交
	function check(){	
		...
		form1.action = "<%= basePath %>T_memberActionUpdate.action";
		form1.submit();
		
	}
	</script>	

<body  onload="loadTcmc()" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" scroll=yes>
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">企业成员信息编辑页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
							    ...
							    <s:hidden  name="t_member.memberid"   value="${t_member.memberid}" />
							  </td>
                            ...
                            <tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
							    ...
							    <select  name="t_member.sex"   id="sex">
							            <option value="${t_member.sex }">${t_member.sex }</option>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<!--
					            	<s:textfield  name="t_member.memo" maxlength='45'  label="memo"/>
					            	-->
					            	 <select  name="t_member.memo"   id="memo">
							            <option value="${t_member.memo }">${t_member.memo }</option>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_member.memo2" maxlength='45'  label="memo2"/>							    
							  </td>
                              <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">&nbsp;</td>                                                           
                            </tr>                                                       
