  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom" background="<s:url value='/images/1_09.gif'/>"><span class="daohang">·T_sale&gt;&gt; t_sale列表</span></td>
      </tr>
      <tr>
					  ...
					  <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td background="<s:url value='/images/1_27.gif'/>" class="daohang">&nbsp;T_sale信息列表页&nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
...
&nbsp;					          
					          ...
					          <td height="25" align="center" valign="middle">&nbsp;
					          	<a href='<s:url action="T_saleActionEdit.action"><s:param name="id" value="id" /></s:url>'>编辑</a>&nbsp;
                              	<a href='<s:url action="T_saleActionRemove.action"><s:param name="id" value="id" /></s:url>'>删除</a>&nbsp;
					          	<a href='<s:url action="T_saleActionView.action"><s:param name="id" value="id" /><s:param name="returnUrl" value="view" /></s:url>'>查看</a>
					          </td>
					        </tr>					      
					      </s:iterator>
					    </table></td>
                      ...
                      <td height="22" colspan="" align="center" valign="middle" bgcolor="#FFFFFF">
			              <input type="button" name="add" value="    新增    " class="btn" onClick="javascript:window.location.href='<s:url value="/jsp/t_sale/t_saleAdd.jsp"/>'" style="cursor:hand">&nbsp;
