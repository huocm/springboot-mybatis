...
function callBackFindLastPrice(){
    ...
    if( http_request.readyState == 4) {
        ...
        if(http_request.status == 200) {                
			//var customerid = document.getElementById("customerid");
			//var results = http_request.responseXML.getElementsByTagName("prices");
			var results = http_request.responseText;
            var msg = document.getElementById("saleprice");
            alert("-----------------");
            alert(results);
            alert(msg);
            msg.value= results ;
...
<body  onload="init()"  class="mainBody" onLoad='if (domok) initTable("table0")' leftmargin="0" topmargin="-20" marginwidth="0" marginheight="0" scroll=no>
                  ...
                  <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td background="<s:url value='/images/1_27.gif'/>" class="daohang">&nbsp;可销售商品信息&nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td valign="top" bgcolor="#cbcbcb">
                         ...
                         <s:iterator value="paginationSupport.items" status="stuts">
							<tr  bgcolor="#FFFFFF" align="center">   							
					          ...
					          <td height="25" align="center" valign="middle">&nbsp;
					            	<input type="text" id="saleprice" name="saleprice;<s:property value='id'/>" value="<s:property value='price'/>" size="5" maxlength="5" />&nbsp;				                 					                   
					          </td>
					          <td height="25" align="center" valign="middle">&nbsp;
                      ...
                      <tr>
                        <td height="22" align="center" colspan="100" bgcolor="#FFFFFF">
							 ...
							 <a href='<s:url value="T_buyActionSaleFind.action">
...
<table id="table0" width="98%" border="1" cellspacing="0" cellpadding="0">
 <tr> 
  <td  height="25" align="left" valign="middle"  class="daohang" >
    &nbsp; 当前出库单中所有商品  
  </td>
  <td colspan="3" height="25" align="left" valign="middle"  class="daohang" >
