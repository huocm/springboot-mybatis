...
function check(){
   ...
   //   return false;
   //}
   form1.action = "${basePath}T_buyActionReturnFind.action?productid="+productid+"&pid="+pid+"&customerid="+customerid+"&startdate="+startdate+"&enddate="+enddate;
   //alert(form1.action );
   form1.submit();
    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·销售管理&gt;&gt; 退货查询</span></td>
      </tr>
      <tr>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							...
							<tr>
							  ...
							  <td width="18%" height="24" align="left" valign="middle" bgcolor="#F2F2F2"> 
							  	&nbsp;主类:<select id="pid" name="t_buy.pid" onChange="myRequestSubRelease()">
							    <option value="">请选择</option> 
							  </select>	
							  </td>
							  <td width="29%" height="24" align="left" valign="middle" bgcolor="#F2F2F2"> 						        
								  ...
								  <select id="productid" name="t_buy.productid" onChange="check()">
								  	<option value="">请选择</option>
								  </select><input type="button" class="btn" value="所有" name="B1" onClick="myRequestSub()" >
							  </td>
                          
                            </tr>
                            <tr>
                              <td colspan="2" width="64%" height="24" align="left" valign="middle" bgcolor="#F2F2F2">						  
							   &nbsp;&nbsp;退货日期:<s:datetimepicker id="startdate" name="startdate" value="today" label="Format (yyyy-MM-dd)" displayFormat="yyyy-MM-dd"/>
							  ...
							  <td width="10%" height="24" align="center" valign="middle" bgcolor="#F2F2F2"> 							  
							     <input type="button" class="btn" value="    退货查询    " name="B1" onClick="check()">								
							  </td>  
							</tr> 	
                              </s:form>																		   
                         </table>                        
