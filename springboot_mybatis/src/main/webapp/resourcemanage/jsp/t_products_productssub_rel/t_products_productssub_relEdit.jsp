...
<title>T_products_productssub_rel信息编辑页</title>
...
<s:form action="T_products_productssub_relActionUpdate" theme="simple">
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">T_products_productssub_rel信息编辑页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
