...
<title>T_order_products_sub信息编辑页</title>
...
<s:form action="T_order_products_subActionUpdate" theme="simple">
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">T_order_products_sub信息编辑页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.id"    label="id"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.subid"    label="subid"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.orderid"    label="orderid"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.name"  maxlength='45'  label="name"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.company"  maxlength='45'  label="company"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.price"    label="price"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.amount"    label="amount"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.num"    label="num"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.type"  maxlength='45'  label="type"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
      							    <s:datetimepicker name="t_order_products_sub.createdate" label="Format (yyyy-MM-dd)" displayFormat="yyyy-MM-dd"></s:datetimepicker> 
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.standard"  maxlength='45'  label="standard"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.memo"  maxlength='45'  label="memo"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.memo2"  maxlength='100'  label="memo2"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.male"  maxlength='45'  label="male"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.married"  maxlength='45'  label="married"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.unmarried"  maxlength='45'  label="unmarried"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.maleprice"    label="maleprice"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.marriedprice"    label="marriedprice"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.unmarriedprice"    label="unmarriedprice"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.companyid"    label="companyid"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.malecost"    label="malecost"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.marriedcost"    label="marriedcost"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.unmarriedcost"    label="unmarriedcost"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_order_products_sub.ordersubid"    label="ordersubid"/>
