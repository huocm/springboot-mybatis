...
function check(){
   ...
   form1.action = "${basePath}T_moneyActionFind.action?customerid="+customerid+"&startdate="+startdate+"&enddate="+enddate;
   //alert(form1.action );
   form1.submit();
                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >应收款记录查询页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
...
<tr>
	<td width="82%" bgcolor="#ad9875">
			<iframe src="T_moneyActionFind.action" align="top" width="100%" scrolling="yes" frameborder="0" height="500" name="under"></iframe>
	</td>
</tr>
</table>
