...
function check(){
   ...
   //  return false;
   //}
   form1.action = "<%=bathPath%>jsp/t_money/t_moneySaveAdmin.jsp?customerid=<%= request.getParameter("customerid")%>";
   //alert(form1.action );
   form1.submit();
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">修改应收款</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
                            ...
                            <tr>
							  <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">应收账款金额:</td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
                            ...
                            <tr>
							  <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">修改应收款金额为:</td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	...
					            	<input type="hidden" name="oldmoney" value="<%= request.getParameter("qianmoney") %>" >						
							  </td>
                              <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">&nbsp;</td>                                                           
                            </tr>                            
							<tr>
							...
							<tr align="center">
								...
								<input class="btn" type="button" value="    修改应收款    " name="B1" onClick="check()">
