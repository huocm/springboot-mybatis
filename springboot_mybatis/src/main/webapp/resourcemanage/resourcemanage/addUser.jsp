...
<s:form action="T_user_detailAdd.action" name="regform" enctype="multipart/form-data" theme="simple" >
  ...
  <table id="right-tb-tb" >
      ...
      <td align="center" width="45%">&nbsp;<font color='red'>${requestScope.typeError}</font> 
	   ...
	   <font color="red"><s:actionmessage/></font>&nbsp;&nbsp; <input name="query" type="button"  onClick="getUno()" value="添加用户">
