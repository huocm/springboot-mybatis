...
mvAry[mvAry.length] = '    <table id="calendarTable" width="100%" style="border:0px solid #CCCCCC;background-color:#FFFFFF" border="0" cellpadding="3" cellspacing="1" background="images/bg.jpg">';
mvAry[mvAry.length] = '      <tr>';
for(var i = 0; i < 7; i++){
