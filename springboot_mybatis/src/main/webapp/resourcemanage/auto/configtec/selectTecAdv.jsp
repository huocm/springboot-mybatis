...
<html>
  ...
  <body> 
<form method="post" action="<%=basePath%>auto/configtec/selectTecAdvSave.jsp" name="form1">
<table width="100%" height="30" cellspacing="0" cellpadding="0" border="0" bgcolor="" align="center">
	<tr><td colspan="2" align="center">&nbsp;<font color="bule" size="6">高级配置</font></td> </tr>
    <tr>
		<td colspan="2"  align="center"><input type="submit" value="保存" name="tj">&nbsp;   <input name="重置" type="reset" value="重置"> </td>
    </tr>
	<tr>
		<td>view层</td>
		<td >
		<input type="radio" value="struts2" name="viewDialiect" checked>struts2 &nbsp;
		<input type="radio" value="spring" name="viewDialiect">spring
		</td>
	</tr>
	<tr>
		<td width="10%">持久层</td>
		<td width="90%" >
		<input type="radio" value="ibatis" name="daoDialiect" checked>ibatis(use spring) &nbsp;
		<input type="radio" value="ibatis2" name="daoDialiect">ibatis2( no use spring)&nbsp;
		<input type="radio" value="hibernate" name="daoDialiect">hibernate3(use spring)&nbsp;
		<input type="radio" value="mydao" name="daoDialiect">mydao
		</td>
    </tr>
    <tr>
