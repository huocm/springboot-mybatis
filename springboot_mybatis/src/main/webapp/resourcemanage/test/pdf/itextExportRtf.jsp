...
try{ 
   ...
   String fileName = "中国五百强企业名次表.rtf"; 
    
    
   File downfile = new File(filePath+ SEPARATOR + fileName); 
   
			//String fileName = "E:\\Tomcat\\T5.5\\bin\\中国五百强企业名次表.pdf"; //"E:\\Tomcat\\T5.5\\bin\\testexcel.xls"; 
			String[] tableHeader ={"第1列表头","第2列表头","第3列表头","第4列表头","第5列表头","第6列表头","第7列表头"}; 
			String titleName = "头头头头test title ";
			String content ="头头头头头头头头头头头头头头test conten头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten 头头头头头头头头头头头头头头test conten  ";
			...
			for(int i=0;i<7;i++){
				...
				for(int j=0;j<7;j++){
					subList.add("测试test"+ i +"-"+ j);
				}
				list.add(subList);
			}
			PdfUtil pd = new PdfUtil(tableHeader, titleName, fileName, content, list,"rtf", null );
			pd.createPdf();
