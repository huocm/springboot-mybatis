		...
		<td>
			<div class="demo" >
				...
				<ul class="tabbtn" id="normaltab">
					<li class="current"><a href="#">1、后台登录</a></li>
				</ul><!--tabbtn end-->
					...
					<div class="sublist"  align="center">
						<ul>
							<li><span>&nbsp;</span>							
									...
									<tr>
										<td>管理账号</td>
										<td><input type="text" value="" maxlength="20"  size="10" name="username" id="username"/></td>
									</tr>
									<tr>
										<td>密码</td>
										<td><input type="password" value="" maxlength="20"  size="10" name="password"  id="password"/></td>
									</tr>
									...
									<tr>										
										...
										<input type="button" class="btn" value=" 登录 "  onclick="checkUser()" >&nbsp;&nbsp;
