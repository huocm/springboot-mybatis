...
<div class="login">
	<div class="login_con">
		<form action="<%=basePath%>"   method="post">
		     <div style="color:#ffffff; font-size: 16px; border-left-width: 580px; padding-left: 540px; padding-top: 15px;font-weight:2px;"><strong>企业员工登录</strong></div>
	 		
	 		<input type="hidden"   name="test"  value="5">
	    	<div class="content">
		       <input name="membername"   id ="membername"  type="text"  class="usr" maxlength="20" />
		       <input name="memberpassword"   id = "memberpassword"  type="password" class="psw" autocomplete="off"  maxlength="20"  />
	        	...
	        	<div class="rem">
	       		...
	       		<div class="smt_btn"><img name=""  value=""   onclick="return checkMember()"  src="<%=basePath %>images/sub_images/btn_01.png" style="-moz-opacity:1; filter:alpha(opacity=100);cursor:hand;" 
