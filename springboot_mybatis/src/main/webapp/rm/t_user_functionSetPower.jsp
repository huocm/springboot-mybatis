                  ...
                  <td height="229" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                         <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF">
							  ...
							  <tr>
		                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
		                            <tr>
		                              ...
		                              <td background="<%= basePath %>images/1_27.gif" class="daohang">&nbsp;用户资源信息列表页&nbsp;</td>
		                            </tr>
		                        </table></td>
		                      </tr>
		                      <tr>
                                ...
                                <%
                                    String dealerno = codeString(request.getParameter("dealerno"));
                                    //String[] ar = roleid.split(";"); 
                                
                                    Rm dao = new Rm();
                                     //获取用户以前配置的功能，下面使用判断，有的话，直接输出 checked 选中
		                            T_user_function t_user_function = new T_user_function();
		                            t_user_function.setDealerno(Integer.parseInt( request.getParameter("dealerno")));
		                            List listUserFunction = dao.t_user_functionListFindByUser(t_user_function);                                   
                                    Map map= new HashMap();
                                    Iterator rfit = listUserFunction.iterator();
                                    while(rfit.hasNext()){
                                    	t_user_function = (T_user_function)rfit.next();
                                    	map.put(t_user_function.getFuncid(), t_user_function);
                                    }
                                %>                                                              
                            <tr onClick="changeTrColor(id)" style="cursor:hand" bgcolor="#FFFFFF" id="trbg0">
                                <td width="" height="22" align="left" bgcolor="#F2F2F2">
                               	 <input type="checkbox" id="ids0" name="ids" value="0" <%if(map.containsKey(0)){out.print("checked");} %> />系统资源
                              	 <input type="hidden" id="dealerno" name="dealerno" value="<%= dealerno %>">
                               </td>
                            </tr>
                            <%
                            ...
                            %>
                            <tr onClick="changeTrColor(id)" style="cursor:hand" bgcolor="#FFFFFF" id="tr<%= vo.getFuncid()%>">
                                <td height="25" align="left" valign="middle">
                                 <% if(vo.getLev()==0 ){%>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox"  id="ids<%= vo.getFuncid()%>" name="ids" value="<%= vo.getFuncid() %>" <%if(map.containsKey(vo.getFuncid())){out.print("checked");} %>/>
                                    <%= vo.getName() %>&nbsp;&nbsp;                                 
                                    <input type="button" name="qx" value=" 全选 " class="btn"  onClick="quanxuan(ids<%= vo.getFuncid()%>)" >&nbsp;
                                    <input type="button" name="fx" value=" 反选 " class="btn"  onClick="fanxuan(ids<%= vo.getFuncid()%>)" >&nbsp;                                    
                                 
                                 <%}else if(vo.getLev()==1 ){ %>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox"  id="ids<%= vo.getPid()%>" name="ids" value="<%= vo.getFuncid() %>" <%if(map.containsKey(vo.getFuncid())){out.print("checked");} %>/>
                                    <%= vo.getName() %>                                      
                                 <%}else if(vo.getLev()==2 ){ %>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <td height="22" colspan="" align="center" valign="middle" bgcolor="#FFFFFF">
			              <input type="button" name="tj" value="    确定    " class="btn"  onClick="javsscript:add()" >&nbsp;
