...
var url = '<%=basePath%>T_customerActionAjax.action?time='+Math.random();
//alert(url);
//要提交到服务器的数据
...
if(http_request.status == 200) {                
    var mubiao = document.getElementById("customerid");
		...
		for(var i = 0; i < results.length; i++) {
		    ...
		    option.setAttribute("value", results[i].getAttribute("id"));  //小心点，又换回去了，value=id;
...
//		}	
		...
		form1.action = "<%= basePath %>T_money_logYsktj.action?pageSize=1000&startIndex=0";
		form1.submit();
    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·财务报表&gt;&gt; 应收款统计</span></td>
      </tr>
      <tr>
                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >应收款统计查询</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
