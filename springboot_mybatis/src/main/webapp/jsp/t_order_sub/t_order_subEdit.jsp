...
function check(){	
	   ...
	   // var num = document.getElementById('num').value;		
		...
		form1.action = "<%= basePath %>T_order_subTaocanUpdate.action";
		form1.submit();
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>"><span class="daohang">·业务管理&gt;&gt; 订单管理&gt;&gt; 套餐信息设置</span></td>
      </tr>
      <tr>
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">订单套餐信息编辑页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
						    ...
						    <tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            <s:textfield  name="profit"   value="${t_order_sub.profit}"   id="num"  readonly="true" />(只读)
							  </td>
                            </tr>  
                            <tr>
							  <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">销售价格:</td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
                               <s:textfield  name="saleprice"  value="${t_order_sub.saleprice}"  id="saleprice"    /><font color="red">*</font>
