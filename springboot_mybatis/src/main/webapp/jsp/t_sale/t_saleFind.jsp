...
function check(){
   ...
   form1.action = "${basePath}T_buyActionSaleFind.action?productid="+productid+"&pid="+pid;
   //alert(form1.action );
   form1.submit();
...
<tr>
	<td width="82%" bgcolor="#ad9875">
			<iframe src="T_buyActionSaleFind.action" align="top" width="100%" scrolling="no" frameborder="0" height="500" name="under"></iframe>
	</td>
</tr>
</table>
</body>
