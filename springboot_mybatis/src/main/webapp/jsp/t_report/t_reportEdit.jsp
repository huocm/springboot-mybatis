...
function check(){	
		...
		form1.action = "<%= basePath %>T_reportActionUpdate.action?time="+Math.random();
		form1.submit();
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>"><span class="daohang">·运营管理&gt;&gt; 体检结果维护&gt;&gt; 体检报告上传</span></td>
      </tr>
      <tr>
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">上传体检报告页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							...
							<tr align="center">
								...
								<input class="btn" type="button" value="    上传报告   " name="B1" onClick="check()">
