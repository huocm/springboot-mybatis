...
function check(){
   ...
   form1.action = "${basePath}T_products_subActionFindByCause.action?id="+id+"&pid="+pid;
   form1.submit();
    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·仓库管理&gt;&gt; 库存查询</span></td>
      </tr>
      <tr>
                     ...
                     <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang" >库存信息查询页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							...
							<tr>
							  ...
							  &nbsp;&nbsp;商品主类:<select id="pid" name="t_products_sub.pid" onChange="myRequestSub()">
							    <option value="">全部</option> 
							  </select>	
							  </td>                             
					          <td width="40%" height="24" align="left" valign="middle" bgcolor="#F2F2F2">
							  &nbsp;&nbsp;商品细类:
							  <select id="id" name="t_products_sub.id">
							  	<option value="">全部</option>
							  </select>
							 </td>                             
					         <td width="40%" height="24" align="left" valign="middle" bgcolor="#F2F2F2">
...
<tr>
	<td width="82%" bgcolor="#ad9875">
			<iframe src="T_products_subActionFindByCause.action" align="top" width="100%" scrolling="no" frameborder="0" height="400" name="under"></iframe>
	</td>
</tr>
</table>
