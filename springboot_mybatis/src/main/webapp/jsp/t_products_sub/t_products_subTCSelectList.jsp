                      ...
                      <tr>
                        ...
                        <tr>
		                      <td height="36" colspan="13" align="center" valign="middle" bgcolor="#FFFFFF">
		                         <input type="button" name="add" value="    确定    " class="btn"   onclick="retVal1()"/> ><%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
			                     <input type="button" name="gb" value="    关闭    " class="btn" onClick="javascript:window.close()" />&nbsp;
		                       	 <input type="button" name="qx" value="    全选      " class="btn"  onClick="quanxuan1(id)" />&nbsp;
                                 <input type="button" name="fx" value="    反选      " class="btn"  onClick="fanxuan1(id)" />&nbsp;
                               </td>
		                    </tr>
                    </table></td>
                </tr>
