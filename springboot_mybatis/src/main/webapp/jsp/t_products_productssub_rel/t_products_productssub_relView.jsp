                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">T_products_productssub_rel信息察看页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.id" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">Productid <font color="#FF0000">*</font></td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.productid" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">Productssubid <font color="#FF0000">*</font></td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.productssubid" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.companyid" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.company" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.memo" />
					            &nbsp;
					          </td>
                            </tr>
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:property value="t_products_productssub_rel.memo2" />
					            &nbsp;
					          </td>
                            </tr>
							<tr align="center">
