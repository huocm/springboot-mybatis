...
<s:form action="T_branchActionUpdate" theme="simple">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>"><span class="daohang">·T_branch&gt;&gt; t_branch</span></td>
      </tr>
      <tr>
                      ...
                      <tr>
                        <td><table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="left" background="<s:url value='/images/1_27.gif'/>" class="daohang">T_branch信息编辑页</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td bgcolor="cbcbcb">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
							...
							<tr>
							  <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">deptname:</td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_branch.deptname"  maxlength='45'  label="deptname"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_branch.status"  maxlength='1'  label="status"/>
							...
							<tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<s:textfield  name="t_branch.memo2"  maxlength='100'  label="memo2"/>
