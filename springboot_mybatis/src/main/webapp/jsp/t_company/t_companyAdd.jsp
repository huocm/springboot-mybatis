    ...
    <td valign="top">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="839" valign="bottom"  background="<s:url value='/images/1_09.gif'/>" ><span class="daohang">·业务管理&gt;&gt; 体检机构维护</span></td>
      </tr>
      <tr>
                      ...
                      <tr>
                        <td bgcolor="cbcbcb">
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="STYLE5">					 
                            ...
                            <tr>
                              ...
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
					            	<select  name="t_company.companytype">
					            		<option value="上海体检机构">上海体检机构</option>
					            		<option value="上海医疗机构">上海医疗机构</option>
					            		<option value="外地体检机构">外地体检机构</option>
					            		<option value="外地医疗机构">外地医疗机构</option>
							...
							<!-- 
							<tr>
							  <td width="40%" height="24" align="right" valign="middle" bgcolor="#F2F2F2">上传体检机构图片:</td>
                              <td width="60%" align="left" valign="middle"  bgcolor="#FFFFFF">&nbsp;
