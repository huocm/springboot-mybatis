		...
		<td>
			<div class="demo" >
				...
				<ul class="tabbtn" id="normaltab">
					<li class="current"><a href="#">1、卡登录</a></li>
						...
						<ul>
							<li><span>&nbsp;</span>
								<table  align="center" border="0" >
									<tr>
										<td>卡号</td>
										<td><input type="text" value="" maxlength="20"  size="10" name="membernameCard" id="membernameCard"/></td>
									</tr>
									<tr>
										<td>密码</td>
										<td><input type="password" value="" maxlength="20"  size="20" name="memberpasswordCard"  id="memberpasswordCard"/></td>
									</tr>
									...
									<tr>										
										...
										<input type="button" class="btn" value=" 登录 "  onclick="checkMemberCard()" >&nbsp;&nbsp;
